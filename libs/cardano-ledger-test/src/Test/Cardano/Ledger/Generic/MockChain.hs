...
import Test.Cardano.Ledger.Generic.PrettyCore (ppLedgersPredicateFailure, ppTickPredicateFailure, txSummary, utxoSummary)
...
ppMockChainState (MockChainState nes sl count) =
  ppRecord
    "MockChainState"
    [ ("NewEpochState", ppNewEpochState nes),
