...
pattern GenesisDelegTxCert ::
  ...
  TxCert era
pattern GenesisDelegTxCert genKey genDelegKey vrf <- (getGenesisDelegTxCert -> Just (GenesisDelegCert genKey genDelegKey vrf))
  where
    GenesisDelegTxCert genKey genDelegKey vrf = mkGenesisDelegTxCert $ GenesisDelegCert genKey genDelegKey vrf
